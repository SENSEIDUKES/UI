...
export const LazyAlbumCard = dynamic(
  () => import("@seihouse/ui").then((mod) => mod.AlbumCard),
  { loading: () => particleFallback },
);

export const LazyArtistCard = dynamic(
  () => import("@seihouse/ui").then((mod) => mod.ArtistCard),
  { loading: () => particleFallback },
);
...
export const LazyMetricCard = dynamic(
  () => import("@seihouse/ui").then((mod) => mod.MetricCard),
  { loading: () => particleFallback },
);
